...
const SearchBlockedMembers: React.FC<InputProps> = ({ icon }) => {
    ...
    useEffect(() => {
        api.get(`/member/search?method=${method}&data=${searchValue}&limit=${25}&isBlocked=true`, {
            headers: {
...
export default SearchBlockedMembers;
